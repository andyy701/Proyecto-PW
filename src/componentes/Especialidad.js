        ...
        <div>
            <div class="text-center m-4">
                ...
                <select id="especialidad">
                    ...
                    <option value="Cirujano Cardiovascular y Torácico">Cirujano Cardiovascular y Torácico</option>
                    ...
                    <option value="Especialista en Medicina Física y Rehabilitación">Especialista en Medicina Física y Rehabilitación</option>
                    <option value="Neumólogo Pediátrico">Neumólogo Pediátrico</option>
                    ...
                    <option value="Especialista En Medicina Intensiva">Especialista En Medicina Intensiva</option>
                    <option value="Especialista En Administración De Salud">Especialista En Administración De Salud</option>
                    <option value="Neurofisiólogo Clínico">Neurofisiólogo Clínico</option>
                    <option value="Patólogo Clínico">Patólogo Clínico</option>
                    <option value="Especialista en Emergencias">Especialista en Emergencias</option>
                    <option value="Especialista En Medicina Estética">Especialista En Medicina Estética</option>
                    ...
                    <option value="Especialista En Medicina Nuclear">Especialista En Medicina Nuclear</option>
                    ...
                    <option value="Especialista En Salud Pública">Especialista En Salud Pública</option>
                    ...
                    <option value="Especialista En Medicina Natural">Especialista En Medicina Natural</option>
                    <option value="Técnico En Laboratorio Clínico">Técnico En Laboratorio Clínico</option>
                    <option value="Enfermero">Enfermero</option>
                    <option value="Especialista En Radioterapia">Especialista En Radioterapia</option>
